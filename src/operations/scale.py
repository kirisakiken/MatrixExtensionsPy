...
class ScaleOperator:
    ...
    @staticmethod
    def __get_scale_matrix_2d(vector_2: Vector2):
        return np.array([[vector_2.x, 0],
                         [0, vector_2.y]])

    @staticmethod
    def __get_scale_matrix_3d(vector_3: Vector3):
    ...
    def get_scale_2d(self, vector_2: Vector2, scale_vector_2: Vector2) -> Vector2:
        scale_matrix = self.__get_scale_matrix_2d(scale_vector_2)
    ...
    def get_scale_3d(self, vector_3: Vector3, scale_vector_3: Vector3) -> Vector3:
        scale_matrix = self.__get_scale_matrix_3d(scale_vector_3)
